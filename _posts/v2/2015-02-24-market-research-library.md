...
Returns market research reports for a specific [controlled industry term]({{ site.baseurl }}/industry-list-market-research-library.html) or [ITA Industry]({{ site.webservices_baseurl }}/ita_taxonomies/search?api_key={{ site.apikey }}&taxonomies=Industries). Enter multiple terms by separating with a comma.
