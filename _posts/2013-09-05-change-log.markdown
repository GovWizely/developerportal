...
| Date            | Change                                                     |
| --------------- | --------------------------------------------------------------- |
| 8/14/15         | Deprecated Version 1 of the APIs.  Please use Version 2 going forward - all endpoints now default to Version 2.  You need to [sign up for an API key](https://api.trade.gov/users/sign_up) to access Version 2   |
